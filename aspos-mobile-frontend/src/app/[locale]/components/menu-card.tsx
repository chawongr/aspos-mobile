      ...
      <div className='flex w-full'>
        ...
        <div className="flex-grow flex flex-col justify-between">
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className="flex items-center justify-center w-[22px] h-[22px] md:w-[28px] md:h-[28px] rounded-full bg-green text-sm md:text-lg font-semibold text-white ">{quantity}</div>
            </div>
        </div>
      </div>
    </div>
